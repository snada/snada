...
Rails.application.config.assets.precompile += %w( style.css global.css team-member.css animations.css prettyPhoto.css blue.css bootstrap-theme.css hover.css)
